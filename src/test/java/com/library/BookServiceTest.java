...
class BookServiceTest {
    ...
    @Test
    void testAddBook() {
        Book book = new Book(1, "Python Programming", "Aicha Lahnouki", "Publisher E", 2023);
        ...
        assertEquals("Python Programming", bookDAO.getById(1).getTitle());
    }

    @Test
    void testUpdateBook() {
        Book originalBook = new Book(1, "Java Programming", "Aicha Lahnouki", "Publisher A", 2023);
        Book updatedBook = new Book(1, "Advanced Java", "Aicha Lahnouki", "Publisher B", 2024);
        ...
        assertEquals("Aicha Lahnouki", retrievedBook.getAuthor());
    }
