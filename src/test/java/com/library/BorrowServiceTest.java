...
class BorrowServiceTest {
    ...
    @Test
    void testBorrowBook() {
        when(studentDAO.getById(1)).thenReturn(new Student(1, "Aicha", "aichalahnouki@example.com"));
        when(bookDAO.getById(1)).thenReturn(new Book(1, "Java Programming", "Meryem Mouride", "Publisher A", 2023));
